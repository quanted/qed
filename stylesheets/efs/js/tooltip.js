 ...
 *     z-index: 500;
 *   }
 *   .tipTop {background: transparent url(images/tipTop.png) no-repeat top; height:37px;}
...
(function($) {
	...
	$.fn.tooltip = function(options, tip_callback) {
		...
		getTip = function() {
			var tTip = '<div class="tip">' + '<div class="tipTop">' + '<a class="hideTip" href="#"><img alt="close" src="images/Button Close.png" border="0"></a>' + '<a class="add_ref" href="#"><img alt="add new reference" src="images/Button Add.png" border="0"></a>' + '</div>' + '<div class="tipMid">' + '<div class="inner" />' + '</div>' + '<div class="tipBtm">' + '</div>' + '</div>';
			return tTip;
		}
		if ($(".tip").length < 1) {
			$("body").prepend(getTip());
