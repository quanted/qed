...
Module Floating_Point_Comparisons
   ...
   Real(Kind=ksp), Parameter :: SP1 = +1.0_ksp ! Single Precision +1.0
   Real(Kind=ksp), Parameter :: SN1 = -1.0_ksp ! Single Precision -1.0
   Real(Kind=kdp), Parameter :: DP1 = +1.0_kdp ! Double Precision +1.0
   Real(Kind=kdp), Parameter :: DN1 = -1.0_kdp ! Double Precision -1.0
...
Contains
   ...
   Elemental Function ssEq(sx, sy) ! ssEq = (sx == sy)
      ...
      z1 = (Nearest(sx,SN1) <= Nearest(sy,SP1))
      z2 = (Nearest(sy,SN1) <= Nearest(sx,SP1))
      ssEq = z1 .And. z2
   End Function ssEq
   ...
   Elemental Function ssGt(sx, sy) ! ssGt = (sx > sy)
      ...
      ssGt = (Nearest(sx,SN1) > Nearest(sy,SP1))
   End Function ssGt
   ...
   Elemental Function ssLe(sx, sy) ! ssLe = (sx <= sy)
      ...
      ssLe = (Nearest(sx,SN1) <= Nearest(sy,SP1))
   End Function ssLe
   ...
   Elemental Function ssGe(sx, sy) ! ssGe = (sx >= sy)
      ...
      ssGe = (Nearest(sx,SP1) >= Nearest(sy,SN1))
   End Function ssGe
   ...
   Elemental Function ssLt(sx, sy) ! ssLt = (sx < sy)
      ...
      ssLt = (Nearest(sx,SP1) < Nearest(sy,SN1))
   End Function ssLt
   ...
   Elemental Function ddEq(dx, dy) ! ddEq = (dx == dy)
      ...
      z1 = (Nearest(dx,DN1) <= Nearest(dy,DP1))
      z2 = (Nearest(dy,DN1) <= Nearest(dx,DP1))
      ddEq = z1 .And. z2
   End Function ddEq
   ...
   Elemental Function ddGt(dx, dy) ! ddGt = (dx > dy)
      ...
      ddGt = (Nearest(dx,DN1) > Nearest(dy,DP1))
   End Function ddGt
   ...
   Elemental Function ddLe(dx, dy) ! ddLe = (dx <= dy)
      ...
      ddLe = (Nearest(dx,DN1) <= Nearest(dy,DP1))
   End Function ddLe
   ...
   Elemental Function ddGe(dx, dy) ! ddGe = (dx >= dy)
      ...
      ddGe = (Nearest(dx,DP1) >= Nearest(dy,DN1))
   End Function ddGe
   ...
   Elemental Function ddLt(dx, dy) ! ddLt = (dx < dy)
      ...
      ddLt = (Nearest(dx,DP1) < Nearest(dy,DN1))
   End Function ddLt
   ...
   Elemental Function sdEq(sx, dy) ! sdEq = (sx == dy)
      ...
      z1 = (Nearest(sx,SN1) <= Nearest(dy,DP1))
      z2 = (Nearest(dy,DN1) <= Nearest(sx,SP1))
      sdEq = z1 .And. z2
   End Function sdEq
   ...
   Elemental Function sdGt(sx, dy) ! sdGt = (sx > dy)
      ...
      sdGt = (Nearest(sx,SN1) > Nearest(dy,DP1))
   End Function sdGt
   ...
   Elemental Function sdLe(sx, dy) ! sdLe = (sx <= dy)
      ...
      sdLe = (Nearest(sx,SN1) <= Nearest(dy,DP1))
   End Function sdLe
   ...
   Elemental Function sdGe(sx, dy) ! sdGe = (sx >= dy)
      ...
      sdGe = (Nearest(sx,SP1) >= Nearest(dy,DN1))
   End Function sdGe
   ...
   Elemental Function sdLt(sx, dy) ! sdLt = (sx < dy)
      ...
      sdLt = (Nearest(sx,SP1) < Nearest(dy,DN1))
   End Function sdLt
   ...
   Elemental Function dsEq(dx, sy) ! dsEq = (dx == sy)
      ...
      z1 = (Nearest(dx,DN1) <= Nearest(sy,SP1))
      z2 = (Nearest(sy,SN1) <= Nearest(dx,DP1))
      dsEq = z1 .And. z2
   End Function dsEq
   ...
   Elemental Function dsGt(dx, sy) ! dsGt = (dx > sy)
      ...
      dsGt = (Nearest(dx,DN1) > Nearest(sy,SP1))
   End Function dsGt
   ...
   Elemental Function dsLe(dx, sy) ! dsLe = (dx <= sy)
      ...
      dsLe = (Nearest(dx,DN1) <= Nearest(sy,SP1))
   End Function dsLe
   ...
   Elemental Function dsGe(dx, sy) ! dsGe = (dx >= sy)
      ...
      dsGe = (Nearest(dx,DP1) >= Nearest(sy,SN1))
   End Function dsGe
   ...
   Elemental Function dsLt(dx, sy) ! dsLt = (dx < sy)
      ...
      dsLt = (Nearest(dx,DP1) < Nearest(sy,SN1))
   End Function dsLt
   ...
   Elemental Function siGt(sx, iy) ! siGt = (sx > iy)
      ...
      sy = Real(iy, Kind=ksp)
      siGt = (Nearest(sx,SN1) > Nearest(sy,SP1))
   End Function siGt
   ...
   Elemental Function siLe(sx, iy) ! siLe = (sx <= iy)
      ...
      sy = Real(iy, Kind=ksp)
      siLe = (Nearest(sx,SN1) <= Nearest(sy,SP1))
   End Function siLe
   ...
   Elemental Function siGe(sx, iy) ! siGe = (sx >= iy)
      ...
      sy = Real(iy, Kind=ksp)
      siGe = (Nearest(sx,SP1) >= Nearest(sy,SN1))
   End Function siGe
   ...
   Elemental Function siLt(sx, iy) ! siLt = (sx < iy)
      ...
      sy = Real(iy, Kind=ksp)
      siLt = (Nearest(sx,SP1) < Nearest(sy,SN1))
   End Function siLt
   ...
   Elemental Function diGt(dx, iy) ! diGt = (dx > iy)
      ...
      dy = Real(iy, Kind=kdp)
      diGt = (Nearest(dx,DN1) > Nearest(dy,DP1))
   End Function diGt
   ...
   Elemental Function diLe(dx, iy) ! diLe = (dx <= iy)
      ...
      dy = Real(iy, Kind=kdp)
      diLe = (Nearest(dx,DN1) <= Nearest(dy,DP1))
   End Function diLe
   ...
   Elemental Function diGe(dx, iy) ! diGe = (dx >= iy)
      ...
      dy = Real(iy, Kind=kdp)
      diGe = (Nearest(dx,DP1) >= Nearest(dy,DN1))
   End Function diGe
   ...
   Elemental Function diLt(dx, iy) ! diLt = (dx < iy)
      ...
      dy = Real(iy, Kind=kdp)
      diLt = (Nearest(dx,DP1) < Nearest(dy,DN1))
   End Function diLt
   ...
   Elemental Function isGt(ix, sy) ! isGt = (ix > sy)
      ...
      sx = Real(ix, Kind=ksp)
      isGt = (Nearest(sx,SN1) > Nearest(sy,SP1))
   End Function isGt
   ...
   Elemental Function isLe(ix, sy) ! isLe = (ix <= sy)
      ...
      sx = Real(ix, Kind=ksp)
      isLe = (Nearest(sx,SN1) <= Nearest(sy,SP1))
   End Function isLe
   ...
   Elemental Function isGe(ix, sy) ! isGe = (ix >= sy)
      ...
      sx = Real(ix, Kind=ksp)
      isGe = (Nearest(sx,SP1) >= Nearest(sy,SN1))
   End Function isGe
   ...
   Elemental Function isLt(ix, sy) ! isLt = (ix < sy)
      ...
      sx = Real(ix, Kind=ksp)
      isLt = (Nearest(sx,SP1) < Nearest(sy,SN1))
   End Function isLt
   ...
   Elemental Function idGt(ix, dy) ! idGt = (ix > dy)
      ...
      dx = Real(ix, Kind=kdp)
      idGt = (Nearest(dx,DN1) > Nearest(dy,DP1))
   End Function idGt
   ...
   Elemental Function idLe(ix, dy) ! idLe = (ix <= dy)
      ...
      dx = Real(ix, Kind=kdp)
      idLe = (Nearest(dx,DN1) <= Nearest(dy,DP1))
   End Function idLe
   ...
   Elemental Function idGe(ix, dy) ! idGe = (ix >= dy)
      ...
      dx = Real(ix, Kind=kdp)
      idGe = (Nearest(dx,DP1) >= Nearest(dy,DN1))
   End Function idGe
   ...
   Elemental Function idLt(ix, dy) ! idLt = (ix < dy)
      ...
      dx = Real(ix, Kind=kdp)
      idLt = (Nearest(dx,DP1) < Nearest(dy,DN1))
   End Function idLt
