...
import json
import logging
logger = logging.getLogger('vvwm_int_Model')
import sys
import rest_funcs


class vvwmIntermediatePage(webapp.RequestHandler):
    def post(self):
        ...
        rest_funcs.update_html(html, jid, 'vvwm')
        self.response.out.write(html)

app = webapp.WSGIApplication([('/.*', vvwmIntermediatePage)], debug=True)
