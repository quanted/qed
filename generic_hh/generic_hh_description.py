...
class genericDescriptionPage(webapp.RequestHandler):
    def get(self):
        text_file1 = open('generic_hh/generic_hh_description.txt','r')
        x = text_file1.read()
        templatepath = os.path.dirname(__file__) + '/../templates/'
        html = template.render(templatepath + '01hh_uberheader.html', {'title':'Ubertool'})
        html = html + template.render(templatepath + '02hh_uberintroblock_wmodellinks.html', {'model':'generic_hh','page':'description'})
