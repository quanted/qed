...
def testMsed(numiter):
    params_matrix = get_params_matrix()
    output = rice_output.msed(params_matrix.get('dsed')[numiter],params_matrix.get('a')[numiter],params_matrix.get('pb')[numiter])
...
def testVW(numiter):
    params_matrix = get_params_matrix()
    output = rice_output.vw(params_matrix.get('dw')[numiter],params_matrix.get('a')[numiter],params_matrix.get('dsed')[numiter],params_matrix.get('osed')[numiter])
...
def testMAI1(numiter):
    params_matrix = get_params_matrix()
    output = rice_output.mai1(params_matrix.get('mai')[numiter],params_matrix.get('a')[numiter])
...
def testCW(numiter):
    params_matrix = get_params_matrix()
    output = rice_output.cw(rice_output.mai1(params_matrix.get('mai')[numiter],params_matrix.get('a')[numiter]),params_matrix.get('dw')[numiter],params_matrix.get('dsed')[numiter],params_matrix.get('osed')[numiter],params_matrix.get('pb')[numiter],params_matrix.get('kd')[numiter])
