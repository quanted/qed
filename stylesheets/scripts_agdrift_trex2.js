$(document).ready(function() {
    ...
    var tab_pool = ["tab_Agdrift", "tab_Chemical", "tab_Avian", "tab_Mammal"];
    var uptab_pool = ["Agdrift", "Chemical", "Avian", "Mammal"];
    ...
    $('li.Agdrift').click(function(){
        ...
        $('li.Chemical,li.Avian, li.Mammal').addClass('tabUnsel').removeClass('tabSel');
        $(".tab:visible").hide();
        $('.tab_Agdrift').show();
        $(".back").hide();
        $(".submit").hide();
    ...
    $('li.Chemical').click(function(){
        ...
        $('li.Agdrift,li.Avian, li.Mammal').addClass('tabUnsel').removeClass('tabSel');
        $(".tab:visible").hide();
        $('.tab_Chemical').show();
        $(".back").hide();
        $(".submit").hide();
    ...
    $('li.Avian').click(function(){
        ...
        $('li.Agdrift,li.Chemical, li.Mammal').addClass('tabUnsel').removeClass('tabSel');
        $(".tab:visible").hide();
        $('.tab_Avian').show();
        $(".back").show();
        $(".submit").hide();
