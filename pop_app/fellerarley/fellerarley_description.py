...
class fellerarleyDescriptionPage(webapp.RequestHandler):
    def get(self):
        text_file2 = open('fellerarley/fellerarley_text.txt','r')
        xx = text_file2.read()         
...
app = webapp.WSGIApplication([('/.*', fellerarleyDescriptionPage)], debug=True)
