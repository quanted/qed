...
class trex2(object):
    def __init__(self, chem_name, use, formu_name, a_i, Application_type, r_s, b_w, a_r_p, p_i, den, h_l, n_a, ar_lb, day_out,
        ...
        #Table12
        self.LD50_rg_bird_sm=self.LD50_rg_bird(Application_type, ar_lb, a_i, p_i, r_s, b_w, aw_bird_sm, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_rg_mamm_sm=self.LD50_rg_mamm(Application_type, ar_lb, a_i, p_i, r_s, b_w, aw_mamm_sm, self.at_mamm, ld50_mamm, tw_mamm)
        self.LD50_rg_bird_md=self.LD50_rg_bird(Application_type, ar_lb, a_i, p_i, r_s, b_w, aw_bird_md, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_rg_mamm_md=self.LD50_rg_mamm(Application_type, ar_lb, a_i, p_i, r_s, b_w, aw_mamm_md, self.at_mamm, ld50_mamm, tw_mamm)
        self.LD50_rg_bird_lg=self.LD50_rg_bird(Application_type, ar_lb, a_i, p_i, r_s, b_w, aw_bird_lg, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_rg_mamm_lg=self.LD50_rg_mamm(Application_type, ar_lb, a_i, p_i, r_s, b_w, aw_mamm_lg, self.at_mamm, ld50_mamm, tw_mamm)

        #Table13
        self.LD50_rl_bird_sm=self.LD50_rl_bird(Application_type, ar_lb, a_i, p_i, b_w, aw_bird_sm, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_rl_mamm_sm=self.LD50_rl_mamm(Application_type, ar_lb, a_i, p_i, b_w, aw_mamm_sm, self.at_mamm, ld50_mamm, tw_mamm)
        self.LD50_rl_bird_md=self.LD50_rl_bird(Application_type, ar_lb, a_i, p_i, b_w, aw_bird_md, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_rl_mamm_md=self.LD50_rl_mamm(Application_type, ar_lb, a_i, p_i, b_w, aw_mamm_md, self.at_mamm, ld50_mamm, tw_mamm)
        self.LD50_rl_bird_lg=self.LD50_rl_bird(Application_type, ar_lb, a_i, p_i, b_w, aw_bird_lg, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_rl_mamm_lg=self.LD50_rl_mamm(Application_type, ar_lb, a_i, p_i, b_w, aw_mamm_lg, self.at_mamm, ld50_mamm, tw_mamm)

        #Table14
        self.LD50_bg_bird_sm=self.LD50_bg_bird(Application_type, ar_lb, a_i, p_i, aw_bird_sm, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_bg_mamm_sm=self.LD50_bg_mamm(Application_type, ar_lb, a_i, p_i, aw_mamm_sm, self.at_mamm, ld50_mamm, tw_mamm)
        self.LD50_bg_bird_md=self.LD50_bg_bird(Application_type, ar_lb, a_i, p_i, aw_bird_md, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_bg_mamm_md=self.LD50_bg_mamm(Application_type, ar_lb, a_i, p_i, aw_mamm_md, self.at_mamm, ld50_mamm, tw_mamm)
        self.LD50_bg_bird_lg=self.LD50_bg_bird(Application_type, ar_lb, a_i, p_i, aw_bird_lg, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_bg_mamm_lg=self.LD50_bg_mamm(Application_type, ar_lb, a_i, p_i, aw_mamm_lg, self.at_mamm, ld50_mamm, tw_mamm)

        #Table15
        self.LD50_bl_bird_sm=self.LD50_bl_bird(Application_type, ar_lb, a_i, p_i, aw_bird_sm, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_bl_mamm_sm=self.LD50_bl_mamm(Application_type, ar_lb, a_i, p_i, aw_mamm_sm, self.at_mamm, ld50_mamm, tw_mamm)
        self.LD50_bl_bird_md=self.LD50_bl_bird(Application_type, ar_lb, a_i, p_i, aw_bird_md, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_bl_mamm_md=self.LD50_bl_mamm(Application_type, ar_lb, a_i, p_i, aw_mamm_md, self.at_mamm, ld50_mamm, tw_mamm)
        self.LD50_bl_bird_lg=self.LD50_bl_bird(Application_type, ar_lb, a_i, p_i, aw_bird_lg, self.at_bird, ld50_bird, tw_bird, x)
        self.LD50_bl_mamm_lg=self.LD50_bl_mamm(Application_type, ar_lb, a_i, p_i, aw_mamm_lg, self.at_mamm, ld50_mamm, tw_mamm)
