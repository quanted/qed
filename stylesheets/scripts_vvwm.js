$(document).ready(function() {
    ...
    var tab_pool = ["tab_Chemical", "tab_Applications", "tab_WaterBody"];
    var uptab_pool = ["Chemical", "Applications", "WaterBody"];
    ...
    $('li.Chemical').click(function(){
        ...
        $('li.Applications, li.WaterBody').addClass('tabUnsel').removeClass('tabSel');
        $(".tab:visible").hide();
        $('.tab_Chemical').show();
        $(".back").hide();
        $(".submit").hide();
    ...
    $('li.WaterBody').click(function(){
        ...
        $('li.Applications, li.Chemical').addClass('tabUnsel').removeClass('tabSel');
        $(".tab:visible").hide();
        $('.tab_WaterBody').show();
        $(".back").show();
        $(".submit").show();
