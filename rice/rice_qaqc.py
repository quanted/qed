...
#import os
#sys.path.append("../")
#from utils import CSVTestParamsLoader
#import logging
#
##print dir(CSVTestParamsLoader)
#cwd= os.getcwd()
#csvTestParamLoader = CSVTestParamsLoader.CSVTestParamsLoader(cwd+'\\rice_unittest_inputs.csv')
#
#test_param_values_dict = csvTestParamLoader.params_matrix
# 
#logger = logging.getLogger(__name__)
#logger.info(test_param_values_dict)
#
#dsed=test_param_values_dict["dsed"]
#a=test_param_values_dict["a"]
#pb=test_param_values_dict["pb"]
#dw=test_param_values_dict["dw"]
#osed=test_param_values_dict["osed"]
#mai=test_param_values_dict["mai"]
#kd=test_param_values_dict["kd"]
######Pre-defined outputs########
#msed=test_param_values_dict["msed_out"]
#out_fun_Msed = []
