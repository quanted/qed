...
class GENEEhistoryPage(webapp.RequestHandler):
    def get(self):
        ...
        html = html + template.render(templatepath + '02uberintroblock_wmodellinks.html', {'model':'genee','page':'history'})
...
app = webapp.WSGIApplication([('/.*', GENEEhistoryPage)], debug=True)
