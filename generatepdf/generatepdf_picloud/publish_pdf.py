...
def generatepdf_pi(input_str): 
    ...
    import generatepdf_pi
    ff=generatepdf_pi.generatepdf_pi(final_str)
    return ff
 
cloud.rest.publish(func=generatepdf_pi, label='generatepdf_pi_s1', _env='t-fortran77-test', _type='s1', _profile=True )
print 'Done gen_pdf'
