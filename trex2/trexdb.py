...
Applicationtarget_CHOICES=(('Short grass','Short grass'),('Tall grass','Tall grass'),('Broad-leafed plants/small insects','Broad-leafed plants/small insects'),
                           ('Fruits/pods/seeds/large insects','Fruits/pods/seeds', 'Arthropods'))
...
#            super(trexInp, self).__init__(*args, **kwargs)
#            self.fields['body_weight_of_the_tested_bird'] = forms.ChoiceField(choices=get_STB_choices(Species_of_the_tested_bird))
#            
