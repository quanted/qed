...
class TerrestrialToxicityBatchLoader:
    ...
    def batchLoadTerrestrialToxicityConfigs(self,params_matrix,terr_config_index,ubertool):
        ...
        terr_tox.put()
        return runUbertoolConfigPage.addTerrestrialToxicityToUbertool(ubertool,terrestrial_toxicity_config_name)
