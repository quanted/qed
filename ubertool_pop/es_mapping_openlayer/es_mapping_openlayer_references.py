...
class ESReferencesPage(webapp.RequestHandler):
    def get(self):
        text_file1 = open('es_mapping_openlayer/es_mapping_openlayer_references.txt','r')
        x = text_file1.read()
        templatepath = os.path.dirname(__file__) + '/../templates/'
        html = template.render(templatepath + '01pop_uberheader.html', {'title':'Ubertool'})
        html = html + template.render(templatepath + '02pop_uberintroblock_wmodellinks.html', {'model':'es_mapping_openlayer','page':'references'})
