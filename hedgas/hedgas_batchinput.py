...
class hedgasBatchInputPage(webapp.RequestHandler):
    def get(self):
        ...
        html = html + template.render(templatepath + '04uberbatchinput.html', {'model':'hedgas'}) 
...
app = webapp.WSGIApplication([('/.*', hedgasBatchInputPage)], debug=True)
