...
class przm5AlgorithmPage(webapp.RequestHandler):
    def get(self):
        ...
        html = html + template.render(templatepath + '02uberintroblock_wmodellinks.html', {'model':'przm5','page':'algorithm'})
...
app = webapp.WSGIApplication([('/.*', przm5AlgorithmPage)], debug=True)
