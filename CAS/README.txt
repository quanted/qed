...
To set up a local CAS database(the default set up), run "./CAS_db_setup.sh ADMIN_USER" (where ADMIN_USER is replaced with a user that has GRANT access and can create tables).
