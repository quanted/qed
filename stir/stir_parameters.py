...
class STIRInp(forms.Form):
    chemical_name = forms.CharField(widget=forms.Textarea (attrs={'cols': 20, 'rows': 2}), label='Chemical Name',initial='Chemical X')
    application_rate = forms.FloatField(required=True, label='Pesticide Application Rate (lbs ai/A)', initial=0.07125)    
    ...
    molecular_weight = forms.FloatField(required=True, label='Molecular Weight',help_text='g/mol',initial=290.01)   
    vapor_pressure = forms.FloatField(required=True, label='Vapor Pressure',help_text='mmHg',initial=4.5e-4)
    avian_oral_ld50 = forms.FloatField(required=True, label=mark_safe('Lowest Avian Oral LD<sub>50</sub>'),help_text='mg/kg-bw',initial=10.)
    ...
    mammal_inhalation_lc50 = forms.FloatField(required=True, label=mark_safe('Lowest Mammal (Rat) Inhalation LC<sub>50</sub>'),help_text='mg/kg-bw',initial=0.65)
    ...
    mammal_oral_ld50 = forms.FloatField(required=True, label=mark_safe('Lowest Mammal (Rat) Oral LD<sub>50</sub>'),help_text='mg/kg-bw',initial=500.)