...
ground_spray_CHOICES=(('a','Low Boom Ground Sprayer (20 Inches or Less)'),
...
class GENEECInp(forms.Form):
    ...
    #B1
    ground_spray_type = forms.ChoiceField(required=True, choices=ground_spray_CHOICES, initial='Low Boom Ground Sprayer (20 Inches or Less)')                                          
    #C1
