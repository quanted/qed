...
class DustInp(forms.Form):
    ...
    low_bird_acute_oral_ld50 = forms.FloatField(required=True,label=mark_safe('Lowest Bird Acute Oral LD<sub>50</sub> &asymp; Amphibian Dermal LD<sub>50</sub>'),initial=7,help_text='mg a.i./kg-bw')
    tested_bird_body_weight = forms.FloatField(required=True,label='Tested Bird Body Weight',initial=120,help_text='g')
    ...
    mamm_acute_derm_ld50 = forms.FloatField(required=True,label=mark_safe('Mammal Acute Dermal LD<sub>50</sub>'),initial=12,help_text='mg a.i./kg-bw')
    tested_mamm_body_weight = forms.FloatField(required=True,label='Tested Mammal Body Weight',initial=750,help_text='g')
