...
class DustInp(forms.Form):
    ...
    application_rate = forms.FloatField(required=True,label='Maximum Single Application Rate (lbs ai/A)',initial=3)
    frac_pest_assumed_at_surface = forms.FloatField(required=True,label='Fraction of Pesticide Assumed at Surface (decimal expression)',initial=.3)
    dislodgeable_foliar_residue = forms.FloatField(required=True,label=mark_safe('Dislodgeable Foliar Residue (mg a.i./cm<sup>2</sup>)'),initial=5)
    ...
    low_bird_acute_oral_ld50 = forms.FloatField(required=True,label=mark_safe('Lowest Bird Acute Oral LD<sub>50</sub> &asymp; Amphibian Dermal LD<sub>50</sub> (mg a.i./kg-bw) '),initial=7)
    tested_bird_body_weight = forms.FloatField(required=True,label='Tested Bird Body Weight (g)',initial=120)
    ...
    mamm_acute_derm_ld50 = forms.FloatField(required=True,label=mark_safe('Mammal Acute Dermal LD<sub>50</sub> (mg a.i./kg-bw)'),initial=12)
    tested_mamm_body_weight = forms.FloatField(required=True,label='Tested Mammal Body Weight (g)',initial=750)
