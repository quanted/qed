...
class TTInp(forms.Form):
    ...
    ld50_a = forms.FloatField(label='Avian Drinking Water LD50 (mg/kg-bw)')
    ...
    bw_avian_ld50 = forms.FloatField(label='Body weight of the assessed avian LD50 (g)')
    bw_avian_lc50 = forms.FloatField(label='Body weight of the assessed avian LC50 (g)')
    bw_avian_NOAEC = forms.FloatField(label='Body weight of the assessed avian NOAEC (g)')
    bw_avian_NOAEL = forms.FloatField(label='Body weight of the assessed avian NOAEL (g)')
    ...
    mammalian_chronic_endpoint = forms.FloatField(label='Mammalian Chronic Endpoint (ppm)')
