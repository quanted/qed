...
class aboutPage(webapp.RequestHandler):
    def get(self):
        ...
        http_html = http_check_tables.table_1(http_headings, http_counter, http_page, http_status, http_reason, counter, counter_ok)
        #print dir(r1)
        html = html + template.render(templatepath + '04ubertext_start.html', {
                'model_page':'',
                'model_attributes':'Ecological Model Integration Testing','text_paragraph':http_html})
        #html = html + http_html
