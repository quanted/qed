...
def html_table(row_inp_all):
    ...
    ###Inputs###########
        ...
        logging.info(vars(therps_obj_temp))
...
def loop_html(thefile):
    ...
    """
    return sum_1+sum_2+sum_3+sum_4+sum_7+sum_5+sum_6+ sum_10+sum_8+sum_9+"".join(out_html_all_sort.values())+html_end
