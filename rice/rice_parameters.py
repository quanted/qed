...
class RiceInp(forms.Form):
	...
	pb = forms.FloatField(required=True,label=mark_safe('Bulk Density of Sediment (kg/m<sup>3</sup>)'), initial=1300)
	dw = forms.FloatField(required=True,label='Water Column Depth (m)', initial=0.10)
	osed = forms.FloatField(required=True,label='Porosity of Sediment', initial=0.509)
	Kd = forms.FloatField(required=True,label='Water-Sediment Partitioning Coefficient (L/kg)', initial=7.27)
