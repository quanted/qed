...
class resexposureBatchInputPage(webapp.RequestHandler):
    def get(self):
        ...
        html = html + template.render(templatepath + '04uberbatchinput.html', {'model':'resexposure'}) 
...
app = webapp.WSGIApplication([('/.*', resexposureBatchInputPage)], debug=True)
