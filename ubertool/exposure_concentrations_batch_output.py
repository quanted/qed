...
class ExposureConcentrationsBatchLoader:
    ...
    def batchLoadExposureConcentrationsConfigs(self,params_matrix):
        params_matrix["ExposureConcentrations"]=[]
        for exposure_concentrations_config_index in range(len(params_matrix.get('one_in_ten_peak_exposure_concentration'))):
            ...
            exposure.put()
            params_matrix["ExposureConcentrations"].append(exposure)
