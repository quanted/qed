...
class lesliedrReferencesPage(webapp.RequestHandler):
    def get(self):
        ...
        html = html + template.render(templatepath + '02pop_uberintroblock_wmodellinks.html', {'model':'lesliedr','page':'references'})
...
app = webapp.WSGIApplication([('/.*', lesliedrReferencesPage)], debug=True)
