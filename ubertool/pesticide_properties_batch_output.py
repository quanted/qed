...
class PesticidePropertiesBatchLoader:
    ...
    def batchLoadPesticidePropertiesConfigs(self,params_matrix,pesticide_properties_config_index,ubertool):
        ...
        pests.put()
        return runUbertoolConfigPage.addPesticidePropertiesToUbertool(ubertool,pesticide_properties_config_name)
