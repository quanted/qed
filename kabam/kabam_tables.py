...
def gett5data(kabam_obj):
    data = { 
        ...
        "Body Weight (kg)": ['%.2f' % kabam_obj.mweight[0][0],'%.2f' % kabam_obj.mweight[0][1],'%.2f' % kabam_obj.mweight[0][2],'%.2f' % kabam_obj.mweight[0][3],'%.2f' % kabam_obj.mweight[0][4],'%.2f' % kabam_obj.mweight[0][5],'%.2f' % kabam_obj.aweight[0][0],'%.2f' % kabam_obj.aweight[0][1],'%.2f' % kabam_obj.aweight[0][2],'%.2f' % kabam_obj.aweight[0][3],'%.2f' % kabam_obj.aweight[0][4],'%.2f' % kabam_obj.aweight[0][5]],
        "Dry Food Ingestion Rate (kg-dry food/kg-bw/day)": ['%.3f' % kabam_obj.dfir[0][0],'%.3f' % kabam_obj.dfir[0][1],'%.3f' % kabam_obj.dfir[0][2],'%.3f' % kabam_obj.dfir[0][3],'%.3f' % kabam_obj.dfir[0][4],'%.3f' % kabam_obj.dfir[0][5],'%.3f' % kabam_obj.dfir_a[0][0],'%.3f' % kabam_obj.dfir_a[0][1],'%.3f' % kabam_obj.dfir_a[0][2],'%.3f' % kabam_obj.dfir_a[0][3],'%.3f' % kabam_obj.dfir_a[0][4],'%.3f' % kabam_obj.dfir_a[0][5]],
        "Wet Food Ingestion Rate (kg-wet food/kg-bw/day)": ['%.3f' % kabam_obj.wet_food_ingestion_m[0][0],'%.3f' % kabam_obj.wet_food_ingestion_m[0][1],'%.3f' % kabam_obj.wet_food_ingestion_m[0][2],'%.3f' % kabam_obj.wet_food_ingestion_m[0][3],'%.3f' % kabam_obj.wet_food_ingestion_m[0][4],'%.3f' % kabam_obj.wet_food_ingestion_m[0][5],'%.3f' % kabam_obj.wet_food_ingestion_a[0][0],'%.3f' % kabam_obj.wet_food_ingestion_a[0][1],'%.3f' % kabam_obj.wet_food_ingestion_a[0][2],'%.3f' % kabam_obj.wet_food_ingestion_a[0][3],'%.3f' % kabam_obj.wet_food_ingestion_a[0][4],'%.3f' % kabam_obj.wet_food_ingestion_a[0][5]],
        "Drinking Water Intake (L/d)": ['%.3f' % kabam_obj.drinking_water_intake_m[0][0],'%.3f' % kabam_obj.drinking_water_intake_m[0][1],'%.3f' % kabam_obj.drinking_water_intake_m[0][2],'%.3f' % kabam_obj.drinking_water_intake_m[0][3],'%.3f' % kabam_obj.drinking_water_intake_m[0][4],'%.3f' % kabam_obj.drinking_water_intake_m[0][5],'%.3f' % kabam_obj.drinking_water_intake_a[0][0],'%.3f' % kabam_obj.drinking_water_intake_a[0][1],'%.3f' % kabam_obj.drinking_water_intake_a[0][2],'%.3f' % kabam_obj.drinking_water_intake_a[0][3],'%.3f' % kabam_obj.drinking_water_intake_a[0][4],'%.3f' % kabam_obj.drinking_water_intake_a[0][5]],
        "Dose Based (mg/kg-bw/d)": ['%.3f' % kabam_obj.db4[0][0],'%.3f' % kabam_obj.db4[0][1],'%.3f' % kabam_obj.db4[0][2],'%.3f' % kabam_obj.db4[0][3],'%.3f' % kabam_obj.db4[0][4],'%.3f' % kabam_obj.db4[0][5],'%.4f' % kabam_obj.db4a[0][0],'%.4f' % kabam_obj.db4a[0][1],'%.4f' % kabam_obj.db4a[0][2],'%.4f' % kabam_obj.db4a[0][3],'%.4f' % kabam_obj.db4a[0][4],'%.4f' % kabam_obj.db4a[0][5]],
...
def gett5dataqaqc(kabam_obj):
    data = { 
        ...
        "Body Weight (kg)": ['%.2f' % kabam_obj.mweight[0][0],'%.2f' % kabam_obj.mweight0_exp,'%.2f' % kabam_obj.mweight[0][1],'%.2f' % kabam_obj.mweight1_exp,'%.2f' % kabam_obj.mweight[0][2],'%.2f' % kabam_obj.mweight2_exp,'%.2f' % kabam_obj.mweight[0][3],'%.2f' % kabam_obj.mweight3_exp,'%.2f' % kabam_obj.mweight[0][4],'%.2f' % kabam_obj.mweight4_exp,'%.2f' % kabam_obj.mweight[0][5],'%.2f' % kabam_obj.mweight5_exp,'%.2f' % kabam_obj.aweight[0][0],'%.2f' % kabam_obj.aweight0_exp,'%.2f' % kabam_obj.aweight[0][1],'%.2f' % kabam_obj.aweight1_exp,'%.2f' % kabam_obj.aweight[0][2],'%.2f' % kabam_obj.aweight2_exp,'%.2f' % kabam_obj.aweight[0][3],'%.2f' % kabam_obj.aweight3_exp,'%.2f' % kabam_obj.aweight[0][4],'%.2f' % kabam_obj.aweight4_exp,'%.2f' % kabam_obj.aweight[0][5],'%.2f' % kabam_obj.aweight5_exp],
        "Dry Food Ingestion Rate (kg-dry food/kg-bw/day)": ['%.3f' % kabam_obj.dfir[0][0],'%.3f' % kabam_obj.dfir0_exp,'%.3f' % kabam_obj.dfir[0][1],'%.3f' % kabam_obj.dfir1_exp,'%.3f' % kabam_obj.dfir[0][2],'%.3f' % kabam_obj.dfir2_exp,'%.3f' % kabam_obj.dfir[0][3],'%.3f' % kabam_obj.dfir3_exp,'%.3f' % kabam_obj.dfir[0][4],'%.3f' % kabam_obj.dfir4_exp,'%.3f' % kabam_obj.dfir[0][5],'%.3f' % kabam_obj.dfir5_exp,'%.3f' % kabam_obj.dfir_a[0][0],'%.3f' % kabam_obj.dfira0_exp,'%.3f' % kabam_obj.dfir_a[0][1],'%.3f' % kabam_obj.dfira1_exp,'%.3f' % kabam_obj.dfir_a[0][2],'%.3f' % kabam_obj.dfira2_exp,'%.3f' % kabam_obj.dfir_a[0][3],'%.3f' % kabam_obj.dfira3_exp,'%.3f' % kabam_obj.dfir_a[0][4],'%.3f' % kabam_obj.dfira4_exp,'%.3f' % kabam_obj.dfir_a[0][5],'%.3f' % kabam_obj.dfira5_exp],
        "Wet Food Ingestion Rate (kg-wet food/kg-bw/day)": ['%.3f' % kabam_obj.wet_food_ingestion_m[0][0],'%.3f' % kabam_obj.wet_food_ingestion_m0_exp,'%.3f' % kabam_obj.wet_food_ingestion_m[0][1],'%.3f' % kabam_obj.wet_food_ingestion_m1_exp,'%.3f' % kabam_obj.wet_food_ingestion_m[0][2],'%.3f' % kabam_obj.wet_food_ingestion_m2_exp,'%.3f' % kabam_obj.wet_food_ingestion_m[0][3],'%.3f' % kabam_obj.wet_food_ingestion_m3_exp,'%.3f' % kabam_obj.wet_food_ingestion_m[0][4],'%.3f' % kabam_obj.wet_food_ingestion_m4_exp,'%.3f' % kabam_obj.wet_food_ingestion_m[0][5],'%.3f' % kabam_obj.wet_food_ingestion_m5_exp,'%.3f' % kabam_obj.wet_food_ingestion_a[0][0],'%.3f' % kabam_obj.wet_food_ingestion_a0_exp,'%.3f' % kabam_obj.wet_food_ingestion_a[0][1],'%.3f' % kabam_obj.wet_food_ingestion_a1_exp,'%.3f' % kabam_obj.wet_food_ingestion_a[0][2],'%.3f' % kabam_obj.wet_food_ingestion_a2_exp,'%.3f' % kabam_obj.wet_food_ingestion_a[0][3],'%.3f' % kabam_obj.wet_food_ingestion_a3_exp,'%.3f' % kabam_obj.wet_food_ingestion_a[0][4],'%.3f' % kabam_obj.wet_food_ingestion_a4_exp,'%.3f' % kabam_obj.wet_food_ingestion_a[0][5],'%.3f' % kabam_obj.wet_food_ingestion_a5_exp],
        "Drinking Water Intake (L/d)": ['%.3f' % kabam_obj.drinking_water_intake_m[0][0],'%.3f' % kabam_obj.drinking_water_intake_m0_exp,'%.3f' % kabam_obj.drinking_water_intake_m[0][1],'%.3f' % kabam_obj.drinking_water_intake_m1_exp,'%.3f' % kabam_obj.drinking_water_intake_m[0][2],'%.3f' % kabam_obj.drinking_water_intake_m2_exp,'%.3f' % kabam_obj.drinking_water_intake_m[0][3],'%.3f' % kabam_obj.drinking_water_intake_m3_exp,'%.3f' % kabam_obj.drinking_water_intake_m[0][4],'%.3f' % kabam_obj.drinking_water_intake_m4_exp,'%.3f' % kabam_obj.drinking_water_intake_m[0][5],'%.3f' % kabam_obj.drinking_water_intake_m5_exp,'%.3f' % kabam_obj.drinking_water_intake_a[0][0],'%.3f' % kabam_obj.drinking_water_intake_a0_exp,'%.3f' % kabam_obj.drinking_water_intake_a[0][1],'%.3f' % kabam_obj.drinking_water_intake_a1_exp,'%.3f' % kabam_obj.drinking_water_intake_a[0][2],'%.3f' % kabam_obj.drinking_water_intake_a2_exp,'%.3f' % kabam_obj.drinking_water_intake_a[0][3],'%.3f' % kabam_obj.drinking_water_intake_a3_exp,'%.3f' % kabam_obj.drinking_water_intake_a[0][4],'%.3f' % kabam_obj.drinking_water_intake_a4_exp,'%.3f' % kabam_obj.drinking_water_intake_a[0][5],'%.3f' % kabam_obj.drinking_water_intake_a5_exp],
        "Dose Based (mg/kg-bw/d)": ['%.3f' % kabam_obj.db4[0][0],'%.3f' % kabam_obj.db40_exp,'%.3f' % kabam_obj.db4[0][1],'%.3f' % kabam_obj.db41_exp,'%.3f' % kabam_obj.db4[0][2],'%.3f' % kabam_obj.db42_exp,'%.3f' % kabam_obj.db4[0][3],'%.3f' % kabam_obj.db43_exp,'%.3f' % kabam_obj.db4[0][4],'%.3f' % kabam_obj.db44_exp,'%.3f' % kabam_obj.db4[0][5],'%.3f' % kabam_obj.db45_exp,'%.4f' % kabam_obj.db4a[0][0],'%.4f' % kabam_obj.db4a0_exp,'%.4f' % kabam_obj.db4a[0][1],'%.4f' % kabam_obj.db4a1_exp,'%.4f' % kabam_obj.db4a[0][2],'%.4f' % kabam_obj.db4a2_exp,'%.4f' % kabam_obj.db4a[0][3],'%.4f' % kabam_obj.db4a3_exp,'%.4f' % kabam_obj.db4a[0][4],'%.4f' % kabam_obj.db4a4_exp,'%.4f' % kabam_obj.db4a[0][5],'%.4f' % kabam_obj.db4a5_exp],
...
def gett6data(kabam_obj):
    data = { 
        "Wildlife Species": ['fog/water shrew','rice rate/star nosed mole','small mink','large mink','small river otter','large river otter','sandpipers','cranes','rails','herons','small osprey','white pelican'],
        "Acute Dose Based (mg/kg-bw)": ['%.2f' % kabam_obj.acute_dose_based_m[0][0],'%.2f' % kabam_obj.acute_dose_based_m[0][1],'%.2f' % kabam_obj.acute_dose_based_m[0][2],'%.2f' % kabam_obj.acute_dose_based_m[0][3],'%.2f' % kabam_obj.acute_dose_based_m[0][4],'%.2f' % kabam_obj.acute_dose_based_m[0][5],'%.2f' % kabam_obj.acute_dose_based_a[0][0],'%.2f' % kabam_obj.acute_dose_based_a[0][1],'%.2f' % kabam_obj.acute_dose_based_a[0][2],'%.2f' % kabam_obj.acute_dose_based_a[0][3],'%.2f' % kabam_obj.acute_dose_based_a[0][4],'%.2f' % kabam_obj.acute_dose_based_a[0][5]],
        ...
        "Chronic Dose Based (mg/kg-bw)": ['%.2f' % kabam_obj.chronic_dose_based_m[0][0],'%.2f' % kabam_obj.chronic_dose_based_m[0][1],'%.2f' % kabam_obj.chronic_dose_based_m[0][2],'%.2f' % kabam_obj.chronic_dose_based_m[0][3],'%.2f' % kabam_obj.chronic_dose_based_m[0][4],'%.2f' % kabam_obj.chronic_dose_based_m[0][5],'N/A','N/A','N/A','N/A','N/A','N/A'],
...
def gett6dataqaqc(kabam_obj):
    data = { 
        "Wildlife Species": ['fog/water shrew','Expected fog/water shrew','rice rate/star nosed mole','Expected rice rate/star nosed mole','small mink','Expected small mink','large mink','Expected large mink','small river otter','Expected small river otter','large river otter','Expected large river otter','sandpipers','Expected sandpipers','cranes','Expected cranes','rails','Expected rails','herons','Expected herons','small osprey','Expected small osprey','white pelican','Expected white pelican'],
        "Acute Dose Based (mg/kg-bw)": ['%.2f' % kabam_obj.acute_dose_based_m[0][0],'%.2f' % kabam_obj.acute_dose_based_m0_exp,'%.2f' % kabam_obj.acute_dose_based_m[0][1],'%.2f' % kabam_obj.acute_dose_based_m1_exp,'%.2f' % kabam_obj.acute_dose_based_m[0][2],'%.2f' % kabam_obj.acute_dose_based_m2_exp,'%.2f' % kabam_obj.acute_dose_based_m[0][3],'%.2f' % kabam_obj.acute_dose_based_m3_exp,'%.2f' % kabam_obj.acute_dose_based_m[0][4],'%.2f' % kabam_obj.acute_dose_based_m4_exp,'%.2f' % kabam_obj.acute_dose_based_m[0][5],'%.2f' % kabam_obj.acute_dose_based_m5_exp,'%.2f' % kabam_obj.acute_dose_based_a[0][0],'%.2f' % kabam_obj.acute_dose_based_a0_exp,'%.2f' % kabam_obj.acute_dose_based_a[0][1],'%.2f' % kabam_obj.acute_dose_based_a1_exp,'%.2f' % kabam_obj.acute_dose_based_a[0][2],'%.2f' % kabam_obj.acute_dose_based_a2_exp,'%.2f' % kabam_obj.acute_dose_based_a[0][3],'%.2f' % kabam_obj.acute_dose_based_a3_exp,'%.2f' % kabam_obj.acute_dose_based_a[0][4],'%.2f' % kabam_obj.acute_dose_based_a4_exp,'%.2f' % kabam_obj.acute_dose_based_a[0][5],'%.2f' % kabam_obj.acute_dose_based_a5_exp],
        ...
        "Chronic Dose Based (mg/kg-bw)": ['%.2f' % kabam_obj.chronic_dose_based_m[0][0],'%.2f' % kabam_obj.chronic_dose_based_m0_exp,'%.2f' % kabam_obj.chronic_dose_based_m[0][1],'%.2f' % kabam_obj.chronic_dose_based_m1_exp,'%.2f' % kabam_obj.chronic_dose_based_m[0][2],'%.2f' % kabam_obj.chronic_dose_based_m2_exp,'%.2f' % kabam_obj.chronic_dose_based_m[0][3],'%.2f' % kabam_obj.chronic_dose_based_m3_exp,'%.2f' % kabam_obj.chronic_dose_based_m[0][4],'%.2f' % kabam_obj.chronic_dose_based_m4_exp,'%.2f' % kabam_obj.chronic_dose_based_m[0][5],'%.2f' % kabam_obj.chronic_dose_based_m5_exp,'N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A'],
...
def gett7data(kabam_obj):
    data = { 
        "Wildlife Species": ['fog/water shrew','rice rate/star nosed mole','small mink','large mink','small river otter','large river otter','sandpipers','cranes','rails','herons','small osprey','white pelican'],
        "Acute Dose Based": ['%.3f' % kabam_obj.acute_rq_dose_m[0][0],'%.3f' % kabam_obj.acute_rq_dose_m[0][1],'%.3f' % kabam_obj.acute_rq_dose_m[0][2],'%.3f' % kabam_obj.acute_rq_dose_m[0][3],'%.3f' % kabam_obj.acute_rq_dose_m[0][4],'%.3f' % kabam_obj.acute_rq_dose_m[0][5],'%.3f' % kabam_obj.acute_rq_dose_a[0][0],'%.3f' % kabam_obj.acute_rq_dose_a[0][1],'%.3f' % kabam_obj.acute_rq_dose_a[0][2],'%.3f' % kabam_obj.acute_rq_dose_a[0][3],'%.3f' % kabam_obj.acute_rq_dose_a[0][4],'%.3f' % kabam_obj.acute_rq_dose_a[0][5]],
        ...
        "Chronic Dose Based": ['%.3f' % kabam_obj.chronic_rq_dose_m[0][0],'%.3f' % kabam_obj.chronic_rq_dose_m[0][1],'%.3f' % kabam_obj.chronic_rq_dose_m[0][2],'%.3f' % kabam_obj.chronic_rq_dose_m[0][3],'%.3f' % kabam_obj.chronic_rq_dose_m[0][4],'%.3f' % kabam_obj.chronic_rq_dose_m[0][5],'N/A','N/A','N/A','N/A','N/A','N/A'],
...
def gett7dataqaqc(kabam_obj):
    data = { 
        "Wildlife Species": ['fog/water shrew','Expected fog/water shrew','rice rate/star nosed mole','Expected rice rate/star nosed mole','small mink','Expected small mink','large mink','Expected large mink','small river otter','Expected small river otter','large river otter','Expected large river otter','sandpipers','Expected sandpipers','cranes','Expected cranes','rails','Expected rails','herons','Expected herons','small osprey','Expected small osprey','white pelican','Expected white pelican'],
        "Acute Dose Based": ['%.3f' % kabam_obj.acute_rq_dose_m[0][0],'%.3f' % kabam_obj.acute_rq_dose_m0_exp,'%.3f' % kabam_obj.acute_rq_dose_m[0][1],'%.3f' % kabam_obj.acute_rq_dose_m1_exp,'%.3f' % kabam_obj.acute_rq_dose_m[0][2],'%.3f' % kabam_obj.acute_rq_dose_m2_exp,'%.3f' % kabam_obj.acute_rq_dose_m[0][3],'%.3f' % kabam_obj.acute_rq_dose_m3_exp,'%.3f' % kabam_obj.acute_rq_dose_m[0][4],'%.3f' % kabam_obj.acute_rq_dose_m4_exp,'%.3f' % kabam_obj.acute_rq_dose_m[0][5],'%.3f' % kabam_obj.acute_rq_dose_m5_exp,'%.3f' % kabam_obj.acute_rq_dose_a[0][0],'%.3f' % kabam_obj.acute_rq_dose_a0_exp,'%.3f' % kabam_obj.acute_rq_dose_a[0][1],'%.3f' % kabam_obj.acute_rq_dose_a1_exp,'%.3f' % kabam_obj.acute_rq_dose_a[0][2],'%.3f' % kabam_obj.acute_rq_dose_a2_exp,'%.3f' % kabam_obj.acute_rq_dose_a[0][3],'%.3f' % kabam_obj.acute_rq_dose_a3_exp,'%.3f' % kabam_obj.acute_rq_dose_a[0][4],'%.3f' % kabam_obj.acute_rq_dose_a4_exp,'%.3f' % kabam_obj.acute_rq_dose_a[0][5],'%.3f' % kabam_obj.acute_rq_dose_a5_exp],
        ...
        "Chronic Dose Based": ['%.3f' % kabam_obj.chronic_rq_dose_m[0][0],'%.3f' % kabam_obj.chronic_rq_dose_m0_exp,'%.3f' % kabam_obj.chronic_rq_dose_m[0][1],'%.3f' % kabam_obj.chronic_rq_dose_m1_exp,'%.3f' % kabam_obj.chronic_rq_dose_m[0][2],'%.3f' % kabam_obj.chronic_rq_dose_m2_exp,'%.3f' % kabam_obj.chronic_rq_dose_m[0][3],'%.3f' % kabam_obj.chronic_rq_dose_m3_exp,'%.3f' % kabam_obj.chronic_rq_dose_m[0][4],'%.3f' % kabam_obj.chronic_rq_dose_m4_exp,'%.3f' % kabam_obj.chronic_rq_dose_m[0][5],'%.3f' % kabam_obj.chronic_rq_dose_m5_exp,'N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A'],
