...
# ####################################################
        ...
        self.x_precip=[float(i) for i in self.final_res[2][1]]
        self.x_runoff=[float(i) for i in self.final_res[2][2]]
        self.x_et=[float(i) for i in self.final_res[2][3]]
        self.x_irr=[float(i) for i in self.final_res[2][4]]
        self.x_leachate=[float(i) for i in self.final_res[2][5]]
