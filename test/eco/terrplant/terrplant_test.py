...
def testLOCnmsdry(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOCnmsdry_out'][numiter], 3)

def testNmsRQsemi(numiter):
    params_matrix = get_params_matrix()
    output = terrplant_model.nmsRQsemi(params_matrix.get('totalsemi_out')[numiter],params_matrix.get('totalsemi_out')[numiter])
...
def testLOCnmssemi(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOCnmssemi_out'][numiter], 3)
...
def testLOCnmsspray(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOCnmsspray_out'][numiter], 3)
...
def testLOClmsdry(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOClmsdry_out'][numiter], 3)
...
def testLOClmssemi(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOClmssemi_out'][numiter], 3)
...
def testLOCndsdry(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOCndsdry_out'][numiter], 3)
...
def testLOCndssemi(numiter):
    params_matrix = get_params_matrix()
    output = terrplant_model.ndsRQsemi(params_matrix.get('ndsRQsemi_out')[numiter])
    print "Test of function name: %s expected: %i != calculated: %i" % ("LOCndssemi", params_matrix.get('LOCndssemi_out')[numiter], output)
    assert round(output, 3) == round(params_matrix['LOCndssemi_out'][numiter], 3)
...
def testLOCndsspray(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOCndsspray_out'][numiter], 3)
...
def testLOCldsdry(numiter):
    params_matrix = get_params_matrix()
    output = terrplant_model.ldsRQdry(params_matrix.get('ldsRQdry_out')[numiter])
    print "Test of function name: %s expected: %i != calculated: %i" % ("LOCldsdry", params_matrix.get('LOCldsdry_out')[numiter], output)
    assert round(output, 3) == round(params_matrix['LOCldsdry_out'][numiter], 3)
...
def testLOCldssemi(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOCldssemi_out'][numiter], 3)
...
def testLOCldsspray(numiter):
    ...
    assert round(output, 3) == round(params_matrix['LOCldsspray_out'][numiter], 3)