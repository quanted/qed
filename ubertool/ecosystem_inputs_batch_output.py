...
class EcosystemInputsBatchLoader:
    ...
    def batchLoadEcosystemInputsConfigs(self,params_matrix,ecosystem_config_index,ubertool):
        ...
        ecosystem.put()
        return runUbertoolConfigPage.addEcosystemInputsToUbertool(ubertool,ecosystem_inputs_config_name)                
