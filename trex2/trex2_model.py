...
class trex2(object):
    def __init__(self, chem_name, use, formu_name, a_i, Application_type, seed_treatment_formulation_name, seed_crop, seed_crop_v, r_s, b_w, p_i, den, h_l, n_a, rate_out, day_out,
        ...
        self.EEC_diet_TG = self.EEC_diet(self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.EEC_diet_BP = self.EEC_diet(self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.EEC_diet_FR = self.EEC_diet(self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        ...
        self.ARQ_diet_bird_SG_C = self.CRQ_diet_bird(self.EEC_diet, NOAEC_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l,day_out)
        self.ARQ_diet_bird_TG_A = self.ARQ_diet_bird(self.EEC_diet, lc50_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l,day_out)
        self.ARQ_diet_bird_TG_C = self.CRQ_diet_bird(self.EEC_diet, NOAEC_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l,day_out)
        self.ARQ_diet_bird_BP_A = self.ARQ_diet_bird(self.EEC_diet, lc50_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.ARQ_diet_bird_BP_C = self.CRQ_diet_bird(self.EEC_diet, NOAEC_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.ARQ_diet_bird_FP_A = self.ARQ_diet_bird(self.EEC_diet, lc50_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.ARQ_diet_bird_FP_C = self.CRQ_diet_bird(self.EEC_diet, NOAEC_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.ARQ_diet_bird_AR_A = self.ARQ_diet_bird(self.EEC_diet, lc50_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.ARQ_diet_bird_AR_C = self.CRQ_diet_bird(self.EEC_diet, NOAEC_bird, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
                      
        #Table 9
        self.EEC_dose_mamm_SG_sm=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_sm, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)
        self.EEC_dose_mamm_SG_md=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_md, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)
        self.EEC_dose_mamm_SG_lg=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_lg, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)
        self.EEC_dose_mamm_TG_sm=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_sm, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.EEC_dose_mamm_TG_md=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_md, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.EEC_dose_mamm_TG_lg=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_lg, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.EEC_dose_mamm_BP_sm=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_sm, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.EEC_dose_mamm_BP_md=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_md, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.EEC_dose_mamm_BP_lg=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_lg, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.EEC_dose_mamm_FP_sm=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_sm, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.EEC_dose_mamm_FP_md=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_md, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.EEC_dose_mamm_FP_lg=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_lg, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.EEC_dose_mamm_AR_sm=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_sm, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.EEC_dose_mamm_AR_md=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_md, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.EEC_dose_mamm_AR_lg=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_lg, self.fi_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.EEC_dose_mamm_SE_sm=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_sm, self.fi_mamm, 0.1, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.EEC_dose_mamm_SE_md=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_md, self.fi_mamm, 0.1, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.EEC_dose_mamm_SE_lg=self.EEC_dose_mamm(self.EEC_diet, aw_mamm_lg, self.fi_mamm, 0.1, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)

        #Table 10
        self.ARQ_dose_mamm_SG_sm=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_sm, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)
        self.CRQ_dose_mamm_SG_sm=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_sm, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)
        self.ARQ_dose_mamm_SG_md=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_md, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)
        self.CRQ_dose_mamm_SG_md=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_md, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)
        self.ARQ_dose_mamm_SG_lg=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_lg, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)
        self.CRQ_dose_mamm_SG_lg=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_lg, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 240, h_l, day_out)

        self.ARQ_dose_mamm_TG_sm=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_sm, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.CRQ_dose_mamm_TG_sm=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_sm, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.ARQ_dose_mamm_TG_md=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_md, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.CRQ_dose_mamm_TG_md=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_md, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.ARQ_dose_mamm_TG_lg=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_lg, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)
        self.CRQ_dose_mamm_TG_lg=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_lg, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 110, h_l, day_out)

        self.ARQ_dose_mamm_BP_sm=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_sm, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.CRQ_dose_mamm_BP_sm=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_sm, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.ARQ_dose_mamm_BP_md=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_md, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.CRQ_dose_mamm_BP_md=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_md, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.ARQ_dose_mamm_BP_lg=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_lg, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)
        self.CRQ_dose_mamm_BP_lg=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_lg, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 135, h_l, day_out)

        self.ARQ_dose_mamm_FP_sm=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_sm, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.CRQ_dose_mamm_FP_sm=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_sm, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.ARQ_dose_mamm_FP_md=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_md, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.CRQ_dose_mamm_FP_md=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_md, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.ARQ_dose_mamm_FP_lg=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_lg, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.CRQ_dose_mamm_FP_lg=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_lg, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)

        self.ARQ_dose_mamm_AR_sm=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_sm, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.CRQ_dose_mamm_AR_sm=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_sm, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.ARQ_dose_mamm_AR_md=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_md, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.CRQ_dose_mamm_AR_md=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_md, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.ARQ_dose_mamm_AR_lg=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_lg, self.fi_mamm, ld50_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)
        self.CRQ_dose_mamm_AR_lg=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_lg, self.fi_mamm, tw_mamm, 0.8, self.C_0, self.C_t, n_a, rate_out, a_i, 94, h_l, day_out)

        self.ARQ_dose_mamm_SE_sm=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_sm, self.fi_mamm, ld50_mamm, tw_mamm, 0.1, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.CRQ_dose_mamm_SE_sm=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_sm, self.fi_mamm, tw_mamm, 0.1, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.ARQ_dose_mamm_SE_md=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_md, self.fi_mamm, ld50_mamm, tw_mamm, 0.1, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.CRQ_dose_mamm_SE_md=self.CRQ_dose_mamm(self.EEC_diet, self.EEC_dose_mamm, self.ANOAEL_mamm, NOAEL_mamm, aw_mamm_md, self.fi_mamm, tw_mamm, 0.1, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
        self.ARQ_dose_mamm_SE_lg=self.ARQ_dose_mamm(self.EEC_dose_mamm, self.EEC_diet, self.at_mamm, aw_mamm_lg, self.fi_mamm, ld50_mamm, tw_mamm, 0.1, self.C_0, self.C_t, n_a, rate_out, a_i, 15, h_l, day_out)
