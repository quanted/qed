...
def gett5data(bw_herp_a_sm, bw_herp_a_md, bw_herp_a_lg, LD50_AD_sm, LD50_AD_md, LD50_AD_lg,
    ...
    data = { 
        ...
        "EEC_BP": ['%0.2E' % EEC_dose_BP_sm[0], '%0.2E' % EEC_dose_BP_md[0], '%0.2E' % EEC_dose_BP_lg[0],],
        "ARQ_BP": ['%0.2E' % ARQ_dose_BP_sm[0], '%0.2E' % ARQ_dose_BP_md[0], '%0.2E' % ARQ_dose_BP_lg[0],],
        "EEC_FR": ['%0.2E' % EEC_dose_FR_sm[0], '%0.2E' % EEC_dose_FR_md[0], '%0.2E' % EEC_dose_FR_lg[0],],
        "ARQ_FR": ['%0.2E' % ARQ_dose_FR_sm[0], '%0.2E' % ARQ_dose_FR_md[0], '%0.2E' % ARQ_dose_FR_lg[0],],
        "EEC_HM": ['N/A', '%0.2E' % EEC_dose_HM_md[0], '%0.2E' % EEC_dose_HM_lg[0],],
        "ARQ_HM": ['N/A', '%0.2E' % ARQ_dose_HM_md[0], '%0.2E' % ARQ_dose_HM_lg[0],],
        "EEC_IM": ['N/A', '%0.2E' % EEC_dose_IM_md[0], '%0.2E' % EEC_dose_IM_lg[0],],
        "ARQ_IM": ['N/A', '%0.2E' % ARQ_dose_IM_md[0], '%0.2E' % ARQ_dose_IM_lg[0],],
        "EEC_TP": ['N/A', '%0.2E' % EEC_dose_TP_md[0], '%0.2E' % EEC_dose_TP_lg[0],],
        "ARQ_TP": ['N/A', '%0.2E' % ARQ_dose_TP_md[0], '%0.2E' % ARQ_dose_TP_lg[0],],
    }
    return data
...
def gett6data(avian_lc50, EEC_diet_herp_BL, EEC_ARQ_herp_BL, EEC_diet_herp_FR, EEC_ARQ_herp_FR, EEC_diet_herp_HM, EEC_ARQ_herp_HM, EEC_diet_herp_IM, EEC_ARQ_herp_IM, EEC_diet_herp_TP, EEC_ARQ_herp_TP):
    data = { 
        ...
        "EEC_BP": ['%0.2E' % EEC_diet_herp_BL[0],],
        "ARQ_BP":  ['%0.2E' % EEC_ARQ_herp_BL[0],],
        "EEC_FR": ['%0.2E' % EEC_diet_herp_FR[0],], 
        "ARQ_FR":  ['%0.2E' % EEC_ARQ_herp_FR[0],], 
        "EEC_HM": ['%0.2E' % EEC_diet_herp_HM[0],],
        "ARQ_HM":  ['%0.2E' % EEC_ARQ_herp_HM[0],],
        "EEC_IM": ['%0.2E' % EEC_diet_herp_IM[0],],
        "ARQ_IM":  ['%0.2E' % EEC_ARQ_herp_IM[0],],
        "EEC_TP": ['%0.2E' % EEC_diet_herp_TP[0],],
        "ARQ_TP":  ['%0.2E' % EEC_ARQ_herp_TP[0],],
    }
    return data
...
def gett7data(avian_NOAEC, EEC_diet_herp_BL, EEC_CRQ_herp_BL, EEC_diet_herp_FR, EEC_CRQ_herp_FR, EEC_diet_herp_HM, EEC_CRQ_herp_HM, EEC_diet_herp_IM, EEC_CRQ_herp_IM, EEC_diet_herp_TP, EEC_CRQ_herp_TP):
    data = { 
        ...
        "EEC_BP": ['%0.2E' % EEC_diet_herp_BL[0],],
        "CRQ_BP":  ['%0.2E' % EEC_CRQ_herp_BL[0],],
        "EEC_FR": ['%0.2E' % EEC_diet_herp_FR[0],], 
        "CRQ_FR":  ['%0.2E' % EEC_CRQ_herp_FR[0],], 
        "EEC_HM": ['%0.2E' % EEC_diet_herp_HM[0],],
        "CRQ_HM":  ['%0.2E' % EEC_CRQ_herp_HM[0],],
        "EEC_IM": ['%0.2E' % EEC_diet_herp_IM[0],],
        "CRQ_IM":  ['%0.2E' % EEC_CRQ_herp_IM[0],],
        "EEC_TP": ['%0.2E' % EEC_diet_herp_TP[0],],
        "CRQ_TP":  ['%0.2E' % EEC_CRQ_herp_TP[0],],
    }
    return data
...
def gett5data_qaqc(bw_herp_a_sm, bw_herp_a_md, bw_herp_a_lg, LD50_AD_sm, LD50_AD_md, LD50_AD_lg,
    ...
    data = {
        ...
        "EEC_BP": ['%0.2E' % EEC_dose_BP_sm[0], '%0.2E' % EEC_dose_BP_sm_exp, '%0.2E' % EEC_dose_BP_md[0], '%0.2E' % EEC_dose_BP_md_exp, '%0.2E' % EEC_dose_BP_lg[0], '%0.2E' % EEC_dose_BP_lg_exp,],
        "ARQ_BP": ['%0.2E' % ARQ_dose_BP_sm[0], '%0.2E' % ARQ_dose_BP_sm_exp, '%0.2E' % ARQ_dose_BP_md[0], '%0.2E' % ARQ_dose_BP_md_exp, '%0.2E' % ARQ_dose_BP_lg[0], '%0.2E' % ARQ_dose_BP_lg_exp,],
        "EEC_FR": ['%0.2E' % EEC_dose_FR_sm[0], '%0.2E' % EEC_dose_FR_sm_exp, '%0.2E' % EEC_dose_FR_md[0], '%0.2E' % EEC_dose_FR_md_exp, '%0.2E' % EEC_dose_FR_lg[0], '%0.2E' % EEC_dose_FR_lg_exp,],
        "ARQ_FR": ['%0.2E' % ARQ_dose_FR_sm[0], '%0.2E' % ARQ_dose_FR_sm_exp, '%0.2E' % ARQ_dose_FR_md[0], '%0.2E' % ARQ_dose_FR_md_exp, '%0.2E' % ARQ_dose_FR_lg[0], '%0.2E' % ARQ_dose_FR_lg_exp,],
        "EEC_HM": ['N/A', 'N/A', '%0.2E' % EEC_dose_HM_md[0], '%0.2E' % EEC_dose_HM_md_exp, '%0.2E' % EEC_dose_HM_lg[0], '%0.2E' % EEC_dose_HM_lg_exp,],
        "ARQ_HM": ['N/A', 'N/A', '%0.2E' % ARQ_dose_HM_md[0], '%0.2E' % ARQ_dose_HM_md_exp, '%0.2E' % ARQ_dose_HM_lg[0], '%0.2E' % ARQ_dose_HM_lg_exp,],
        "EEC_IM": ['N/A', 'N/A', '%0.2E' % EEC_dose_IM_md[0], '%0.2E' % EEC_dose_IM_md_exp, '%0.2E' % EEC_dose_IM_lg[0], '%0.2E' % EEC_dose_IM_lg_exp,],
        "ARQ_IM": ['N/A', 'N/A', '%0.2E' % ARQ_dose_IM_md[0], '%0.2E' % ARQ_dose_IM_md_exp, '%0.2E' % ARQ_dose_IM_lg[0], '%0.2E' % ARQ_dose_IM_lg_exp,],
        "EEC_TP": ['N/A', 'N/A', '%0.2E' % EEC_dose_TP_md[0], '%0.2E' % EEC_dose_TP_md_exp, '%0.2E' % EEC_dose_TP_lg[0], '%0.2E' % EEC_dose_TP_lg_exp,],
        "ARQ_TP": ['N/A', 'N/A', '%0.2E' % ARQ_dose_TP_md[0], '%0.2E' % ARQ_dose_TP_md_exp, '%0.2E' % ARQ_dose_TP_lg[0], '%0.2E' % ARQ_dose_TP_lg_exp,],
    }
    return data
...
def gett6data_qaqc(avian_lc50, EEC_diet_herp_BL, EEC_ARQ_herp_BL, EEC_diet_herp_FR, EEC_ARQ_herp_FR, EEC_diet_herp_HM, EEC_ARQ_herp_HM, EEC_diet_herp_IM, EEC_ARQ_herp_IM, EEC_diet_herp_TP, EEC_ARQ_herp_TP,
    ...
    data = {
        ...
        "EEC_BP": ['%0.2E' % EEC_diet_herp_BL[0], '%0.2E' % EEC_diet_herp_BL_exp,],
        "ARQ_BP":  ['%0.2E' % EEC_ARQ_herp_BL[0], '%0.2E' % EEC_ARQ_herp_BL_exp,],
        "EEC_FR": ['%0.2E' % EEC_diet_herp_FR[0], '%0.2E' % EEC_diet_herp_FR_exp,], 
        "ARQ_FR":  ['%0.2E' % EEC_ARQ_herp_FR[0], '%0.2E' % EEC_ARQ_herp_FR_exp,], 
        "EEC_HM": ['%0.2E' % EEC_diet_herp_HM[0], '%0.2E' % EEC_diet_herp_HM_exp,],
        "ARQ_HM":  ['%0.2E' % EEC_ARQ_herp_HM[0], '%0.2E' % EEC_ARQ_herp_HM_exp,],
        "EEC_IM": ['%0.2E' % EEC_diet_herp_IM[0], '%0.2E' % EEC_diet_herp_IM_exp,],
        "ARQ_IM":  ['%0.2E' % EEC_ARQ_herp_IM[0], '%0.2E' % EEC_ARQ_herp_IM_exp,],
        "EEC_TP": ['%0.2E' % EEC_diet_herp_TP[0], '%0.2E' % EEC_diet_herp_TP_exp,],
        "ARQ_TP":  ['%0.2E' % EEC_ARQ_herp_TP[0], '%0.2E' % EEC_ARQ_herp_TP_exp,],
    }
    return data
...
def gett7data_qaqc(avian_NOAEC, EEC_diet_herp_BL, EEC_CRQ_herp_BL, EEC_diet_herp_FR, EEC_CRQ_herp_FR, EEC_diet_herp_HM, EEC_CRQ_herp_HM, EEC_diet_herp_IM, EEC_CRQ_herp_IM, EEC_diet_herp_TP, EEC_CRQ_herp_TP,
    ...
    data = { 
        ...
        "EEC_BP": ['%0.2E' % EEC_diet_herp_BL[0], '%0.2E' % EEC_diet_herp_BL_exp,],
        "CRQ_BP":  ['%0.2E' % EEC_CRQ_herp_BL[0], '%0.2E' % EEC_CRQ_herp_BL_exp,],
        "EEC_FR": ['%0.2E' % EEC_diet_herp_FR[0], '%0.2E' % EEC_diet_herp_FR_exp,], 
        "CRQ_FR":  ['%0.2E' % EEC_CRQ_herp_FR[0], '%0.2E' % EEC_CRQ_herp_FR_exp,], 
        "EEC_HM": ['%0.2E' % EEC_diet_herp_HM[0], '%0.2E' % EEC_diet_herp_HM_exp,],
        "CRQ_HM":  ['%0.2E' % EEC_CRQ_herp_HM[0], '%0.2E' % EEC_CRQ_herp_HM_exp,],
        "EEC_IM": ['%0.2E' % EEC_diet_herp_IM[0], '%0.2E' % EEC_diet_herp_IM_exp,],
        "CRQ_IM":  ['%0.2E' % EEC_CRQ_herp_IM[0], '%0.2E' % EEC_CRQ_herp_IM_exp,],
        "EEC_TP": ['%0.2E' % EEC_diet_herp_TP[0], '%0.2E' % EEC_diet_herp_TP_exp,],
        "CRQ_TP":  ['%0.2E' % EEC_CRQ_herp_TP[0], '%0.2E' % EEC_CRQ_herp_TP_exp,],
    }
    return data
