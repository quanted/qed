...
class oreheBatchInputPage(webapp.RequestHandler):
    def get(self):
        ...
        html = html + template.render(templatepath + '04uberbatchinput.html', {'model':'orehe'}) 
...
app = webapp.WSGIApplication([('/.*', oreheBatchInputPage)], debug=True)
