...
class placeholderPage(webapp.RequestHandler):
    def get(self):
        text_file1 = open('placeholder/placeholder_description.txt','r')
        x = text_file1.read()
        text_file2 = open('placeholder/placeholder_text.txt','r')
        xx = text_file2.read()
...
app = webapp.WSGIApplication([('/.*', placeholderPage)], debug=True)
