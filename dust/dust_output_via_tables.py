...
#        text_file = open('','r')
        ...
        html = html + tmpl.render(Context(dict(data=rows, headings=headings)))
        #tmpl = dust_tables.DefaultDicttoHTML()
        #html = html + tmpl.render(Context(dict(rows, headings=headings)))
