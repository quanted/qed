...
d3.slider = function module() {
  ...
  // Private variables
  var axisScale,
      dispatch = d3.dispatch("slide","slideend","slidestart"),
  ...
  function slider(selection) {
    selection.each(function() {
      ...
      function moveHandle(pos) {
        ...
        var newValue = stepValue( Math.floor(scale.invert(pos / sliderLength)) );
      ...
      function onClickHorizontal() {
        moveHandle((d3.event.offsetX || d3.event.layerX) - 2);
        dispatch.slideend();
      }
