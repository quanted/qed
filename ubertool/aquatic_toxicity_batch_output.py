...
class AquaticToxicityBatchLoader:
    ...
    def batchLoadAquaticToxicityConfigs(self,params_matrix,aqua_config_index,ubertool):
        ...
        return runUbertoolConfigPage.addAquaticToxicityToUbertool(ubertool,aquatic_toxicity_config_name)
