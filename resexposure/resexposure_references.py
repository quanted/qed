...
class resexposureReferencesPage(webapp.RequestHandler):
    def get(self):
        text_file1 = open('resexposure/resexposure_references.txt','r')
        x = text_file1.read()
...
app = webapp.WSGIApplication([('/.*', resexposureReferencesPage)], debug=True)
