...
class genericJonAlgorithmPage(webapp.RequestHandler):
    def get(self):
        text_file1 = open('genericJon/genericJon_algorithm.txt','r')
        x = text_file1.read()
...
app = webapp.WSGIApplication([('/.*', genericJonAlgorithmPage)], debug=True)
